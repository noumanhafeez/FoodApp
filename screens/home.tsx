...
const imagesData = [
    { id: '1', source: require('../assets/images/pizza.png'), text: 'All your favorites!' },
    { id: '2', source: require('../assets/images/pizza1.png'), text: 'Order from chosen chef!' },
    { id: '3', source: require('../assets/images/pizza2.png'), text: 'Free delivery offers!' },
];
